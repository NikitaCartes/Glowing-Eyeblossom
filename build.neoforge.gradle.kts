...
tasks.shadowJar {
    ...
    relocate("org.spongepowered.configurate", "xyz.nikitacartes.glowingeyeblossom.shadow.configurate")
    relocate("com.typesafe.config", "xyz.nikitacartes.glowingeyeblossom.shadow.config")
    relocate("io.leangen.geantyref", "xyz.nikitacartes.glowingeyeblossom.shadow.geantyref")
    relocate("net.kyori.option", "xyz.nikitacartes.glowingeyeblossom.shadow.option")
    relocate("org.apache.commons.text", "xyz.nikitacartes.glowingeyeblossom.shadow.commons.text")
    relocate("org.apache.commons.lang3", "xyz.nikitacartes.glowingeyeblossom.shadow.commons.lang3")
